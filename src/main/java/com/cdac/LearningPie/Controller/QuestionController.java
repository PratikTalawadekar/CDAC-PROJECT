...
public class QuestionController {
     ...
     public String postQuestionInGroup(@RequestBody Questions question,@PathVariable int groupId) {
     ...
     @GetMapping("/getCountOfQuestions")
     public Map<String,Integer> getCountOfQuestions(){
    	 return questionService.getCountOfQuestionsBySubject();
     }
